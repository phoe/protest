...
(define-protocol wiggler ()
  ...
  (:variable *wiggler* (or null wiggler) nil)
...
A wrapper macro that binds *WIGGLER* to the value of WIGGLER."
  ...
  (:function wiggle ((wiggler wiggler) (object fist)) (values))
...
out of it."
  (:function squeeze ((object fist)) :generalized-boolean)
  "Squeezes the fist.
Returns true if the fist was not previously squeezed and false otherwise."
  (:function unsqueeze ((object fist)) :generalized-boolean)
  "Unsqueezes the fist.
Returns true if the fist was previously squeezed and false otherwise."
  (:function wigglep ((object fist)) :generalized-boolean)
